...
{
    public SimpleDownloader(DownloadRequest downloadRequest, long? rangeFrom = null, long? rangeTo = null)
    {
    ...
    public static async Task<SimpleDownloaderResponse> StartNewDownloadAsync(DownloadRequest downloadRequest)
    {
        using var downloader = new SimpleDownloader(downloadRequest);
